...
const INITIAL_ACTIVITY = [
  { id:1, color:'var(--success)', text:'Emma Clarke confirmed for Tue 15 Jul',  bold:'Emma Clarke',        time:'2 min ago' },
...
export function StoreProvider({ children }) {
  ...
  const resolveComplaint = useCallback((id) => {
    setComplaints((prev) => prev.map((c) =>
      c.id === id ? { ...c, badge:'Resolved', badgeVariant:'success', status:'resolved' } : c
    ))
