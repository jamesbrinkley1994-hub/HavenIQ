...
// and any manual overrides set on the Calendar page (block/available)?
// Overrides take priority over the normal weekly schedule.
// Defaults to closed if there's no matching or open day config (safe default).
function isDayOpen(dateStr, workingHours, dateOverrides) {
 ...
 */
export default function DatePicker({ value, onChange, workingHours, dateOverrides, error }) {
        ...
        <div style={{
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(7,1fr)', gap:2 }}>
            {cells.map((d, i) => {
              ...
              const dayOpen  = isDayOpen(dateStr, workingHours, dateOverrides)
