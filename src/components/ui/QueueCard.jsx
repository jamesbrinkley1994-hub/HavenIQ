      ...
      {attachedFile && (
        <div style={{
          ...
          {attachedFile.preview
            ? <img src={attachedFile.preview} alt="ref" style={{width:40,height:40,borderRadius:5,objectFit:'cover',flexShrink:0}}/>
          ...
          <div>
            ...
            <div style={{fontSize:11.5,color:'var(--text-muted)',overflow:'hidden',textOverflow:'ellipsis',whiteSpace:'nowrap',maxWidth:220}}>{attachedFile.name}</div>
          </div>
        </div>
      )}
