      ...
      {attachedFile && (
        <div style={{
          ...
          <div style={{display:'flex',gap:6,flexShrink:0}}>
            {attachedFile.preview && (
              <a href={attachedFile.preview} target="_blank" rel="noreferrer"
                style={{fontSize:11.5,fontWeight:600,color:'var(--primary)',textDecoration:'none',
                  padding:'4px 9px',border:'1px solid var(--primary)',borderRadius:6,background:'#fff'}}>
                View
              </a>
            )}
            {attachedFile.preview && (
