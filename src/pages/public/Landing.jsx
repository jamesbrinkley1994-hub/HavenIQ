    ...
    <div className="lp">
      ...
      <nav className="lp-nav">
        <div className="lp-logo">
          ...
          <span style={{ fontSize: 16, fontWeight: 700 }}>Haven</span>
        </div>
      ...
      <section className="lp-hero">
        ...
        <p className="lp-hero-sub">
          Haven automatically sorts your emails, booking requests, quotes, and complaints —
      ...
      <section className="lp-cta">
        ...
        <p>Join hundreds of small businesses already using Haven to stay organised.</p>
      ...
      <footer className="lp-footer">
        <div style={{ display:'flex', alignItems:'center', gap:7 }}>
          ...
          <span style={{ fontWeight:600, color:'var(--text)' }}>Haven</span>
        </div>
        <span>© 2025 Haven. All rights reserved.</span>
...
const FEATURES = [
  ...
  },
  {
    ...
    desc: 'Approve or decline bookings with one click. Customers book through your personal Haven page.',
  ...
  },
  {
    ...
    desc: 'Haven spots incomplete enquiries and prepares a suggested reply to collect what\'s needed — instantly.',
  ...
  },
  {
    ...
    desc: 'Store your policies, services, and rules. Haven uses this context to handle enquiries intelligently.',
...
const PLANS = [
  {
    ...
    desc: 'Perfect for testing Haven with a handful of bookings per month.',
