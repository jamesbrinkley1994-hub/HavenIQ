            ...
            <div style={{display:'flex',flexDirection:'column',gap:16}}>
              <Card>
                ...
                <div style={{display:'flex',gap:9,flexWrap:'wrap',marginBottom:20}}>
                  ...
                  <Btn variant="secondary" onClick={() => navigate('/haven/book/demo')}>Open booking page ↗</Btn>
                </div>
              ...
              <Card>
                ...
                <p style={{fontSize:13,color:'var(--text-muted)',marginBottom:14}}>See exactly what your customers see when they visit your booking link.</p>
                <Btn variant="secondary" onClick={() => navigate('/haven/book/demo')}>Preview booking page →</Btn>
              </Card>
            </div>
          )}
