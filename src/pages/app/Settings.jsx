            ...
            <div style={{display:'flex',flexDirection:'column',gap:16}}>
              <Card>
                ...
                <div style={{display:'flex',gap:9,flexWrap:'wrap',marginBottom:20}}>
                  ...
                  <Btn variant="secondary" onClick={() => navigate(`/haven/book/${business?.slug || 'demo'}`)}>Open Booking & Enquiry page ↗</Btn>
                </div>
              ...
              <div style={{display:'flex',gap:10,alignItems:'flex-start',padding:'12px 14px',background:'#FFFBEB',border:'1px solid #FDE68A',borderRadius:9}}>
                <span style={{fontSize:16,flexShrink:0}}>📥</span>
                <div>
                  <div style={{fontSize:13,fontWeight:600,color:'#92400E'}}>Check your junk folder</div>
                  <div style={{fontSize:12.5,color:'#92400E',opacity:0.85,marginTop:2}}>
                    New booking, quote and enquiry notifications can land in junk/spam at first — this is normal for a new sender. Mark the first one as "not junk" so future emails go straight to your inbox.
                  </div>
                </div>
              </div>
              <Card>
