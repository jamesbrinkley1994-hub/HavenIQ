    ...
    <AppShell
      ...
      topbarRight={
        <>
          ...
          <Btn variant="primary" size="sm" onClick={()=>navigate('/haven/book/demo')}>Share booking page</Btn>
        </>
      }
    >
      <div style={{marginBottom:18}}>
        ...
        <p style={{fontSize:13,color:'var(--text-muted)',marginTop:2}}>
          {new Date().toLocaleDateString('en-GB',{weekday:'long',day:'numeric',month:'long',year:'numeric'})} — here's what needs your attention.
        </p>
      </div>
      ...
      <div className="dashboard-grid">
        ...
        <Card>
          ...
          {bookings.length===0&&<p style={{fontSize:13,color:'var(--text-muted)',padding:'8px 0'}}>No bookings yet.</p>}
        </Card>
            ...
            <div key={a.id} className="activity-row">
              ...
              <div>
                <div className="activity-text">
                  <strong>{a.bold}</strong>{' '+a.text.replace(a.bold,'').trim()}
                </div>
