      ...
      <div className="onboarding-box">
        ...
        {step === 1 && (
          <div>
            ...
            <div className="ob-sub">This helps Haven personalise your experience and booking page.</div>
        ...
        {step === 4 && (
          <div style={{ textAlign: 'center' }}>
            ...
            <div className="ob-sub">Haven is ready. Your booking page is live and your dashboard is waiting.</div>
