...
export default function Signup() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setError(e.message || e.error_description || e.msg || JSON.stringify(e) || 'Failed to create account. Please try again.')
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="auth-page">
      <div className="auth-box">
        ...
        <div className="auth-form">
          ...
          {error && <div style={{fontSize:13,color:'var(--danger)',padding:'8px 12px',background:'var(--danger-tint)',borderRadius:8,wordBreak:'break-word'}}>⚠ {error}</div>}
